...
//  3RA_EVA_4_SWITCHTING
//
//  Created by LUIS FERNANDO on 04/05/17.
...
class ViewController: UIViewController {
    ...
    @IBAction func barItemButton(sender: AnyObject) {
        ...
        if blueViewController != nil && blueViewController!.view.superview != nil { UIView.setAnimationTransition(.FlipFromRight, forView: view, cache: true)
